...
public class ModifyTable extends TableModify
        implements EnumerableRel {
    public ModifyTable(RelOptCluster cluster, RelTraitSet traits,
    ...
    @Override public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new org.apache.calcite.adapter.enumerable.EnumerableTableModify(
                getCluster(),
                traitSet,
                getTable(),
                getCatalogReader(),
